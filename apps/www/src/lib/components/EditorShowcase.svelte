...
<section id={editor.id} class="showcase">
	<div class="container">
		<p class="kicker">{editor.kicker}</p>
		<h2>{editor.title}</h2>
		<p class="lede">{editor.body}</p>
		...
		<div class="frame">
			...
			<div class="pane" id="tabpanel-{activeTab}" role="tabpanel" aria-label={editor.tabs.find(t => t.id === activeTab)?.label}>
